<!-- 
  KOMPONEN VUE - KANG RALING SITE PAKUWON PAGE
...
<template>
  <div class="tps3r-page">
    ...
    <section class="hero">
      ...
      <div class="hero-content">
        ...
        <p class="hero-subtitle">
          Gerakan Bersama Menuju Desa Bebas Sampah dan Lebih Berdaya.
        </p>
      </div>
    </section>
          ...
          <div class="profil-info-grid">
            ...
            <div class="info-card">
              ...
              <div class="info-content">
                ...
                <p class="info-value">
                  {{ tps3rData.familiesServed }}+ Keluarga
                </p>
              </div>
            </div>
          </div>
      ...
      <div class="container">
        ...
        <div class="section-header light">
          ...
          <p class="section-subtitle">
            Capaian dan dampak nyata TPS 3R Motekar untuk lingkungan
          </p>
        </div>
    ...
    <section class="fasilitator-section">
      <div class="container">
        <div class="section-header">
          <h2 class="section-title">Fasilitator Desa Pakuwon</h2>
          <div class="title-underline"></div>
        </div>
...
import {
  ...
  getMapUrl,
  contactFacilitator,
} from "@/scripts/krsite/pakuwon.js";
...
<style scoped src="@/assets/css/krsite/pakuwon.css"></style>

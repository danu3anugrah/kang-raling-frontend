  ...
  <div class="tps3r-page">
    ...
    <section class="hero">
      ...
      <div class="hero-content">
        ...
        <div class="hero-badge">Bank Sampah Binaan Kang Raling</div>
        <!-- Judul utama halaman dengan nama TPS 3R dan desa -->
        <h1 class="hero-title">
          Bank Sampah Binangkit <br />
          Desa Mekargalih
        </h1>
        <!-- Tagline atau slogan yang mencerminkan visi TPS 3R -->
        <p class="hero-subtitle">
          Dari Sampah Menjadi Nilai Langkah Kecil untuk Dampak Besar.
        </p>
      </div>
    </section>
    ...
    <section class="profil-section">
      <div class="container">
        ...
        <div class="section-header">
          <h2 class="section-title">Profil Bank Sampah</h2>
        ...
        <div class="profil-grid">
          ...
          <div class="profil-card main-card">
            ...
            <h3>Tentang Bank Sampah Binangkit</h3>
          ...
          <div class="profil-info-grid">
            ...
            <div class="info-card">
              ...
              <div class="info-content">
                <p class="info-label">Nama Bank Sampah</p>
            ...
            <div class="info-card">
              ...
              <div class="info-content">
                <p class="info-label">Nasabah Bank Sampah</p>
      ...
      <div class="container">
        ...
        <div class="section-header light">
          ...
          <p class="section-subtitle">
            Capaian dan dampak nyata Bank Sampah Binangkit untuk lingkungan
          </p>
        </div>
    ...
    <section class="fasilitator-section">
      <div class="container">
        <div class="section-header">
          <h2 class="section-title">Fasilitator Bank Sampah Binangkit</h2>
          <div class="title-underline"></div>
        </div>
    ...
    <section class="lokasi-section">
      <div class="container">
        <div class="section-header">
          <h2 class="section-title">Lokasi Bank Sampah</h2>
          <div class="title-underline"></div>
          <p class="section-subtitle">
...
import { 
  ...
  getMapUrl,
  contactFacilitator 
} from '@/scripts/krsite/binangkit.js'
...
<style scoped src="@/assets/css/krsite/binangkit.css"></style>
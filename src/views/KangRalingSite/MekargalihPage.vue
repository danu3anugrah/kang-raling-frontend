<!-- 
  KOMPONEN VUE - KANG RALING SITE MEKARGALIH PAGE
...
<template>
  <div class="tps3r-page">
    ...
    <section class="hero">
      ...
      <div class="hero-content">
        ...
        <p class="hero-subtitle">
          Kolaborasi Warga untuk Pengelolaan Sampah yang Lebih Cerdas dan Berkelanjutan.
        </p>
      </div>
    </section>
    ...
    <section class="fasilitator-section">
      <div class="container">
        <div class="section-header">
          <h2 class="section-title">Fasilitator Desa Mekargalih</h2>
          <div class="title-underline"></div>
        </div>
...
import { 
  ...
  getMapUrl,
  contactFacilitator 
} from '@/scripts/krsite/mekargalih.js'
...
<style scoped src="@/assets/css/krsite/mekargalih.css"></style>
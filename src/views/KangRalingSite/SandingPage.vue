  ...
  <div class="tps3r-page">
    ...
    <section class="hero">
      ...
      <div class="hero-content">
        ...
        <h1 class="hero-title">
          TPS 3R Burung Bao <br />
          Desa Muara Sanding
        </h1>
        <!-- Tagline atau slogan yang mencerminkan visi TPS 3R -->
        <p class="hero-subtitle">
          Solusi Sampah Berkelanjutan untuk Masyarakat yang Lebih Tertib dan Sejahtera.
        </p>
      </div>
    </section>
      ...
      <div class="container">
        ...
        <div class="profil-grid">
          ...
          <div class="profil-card main-card">
            ...
            <h3>Tentang TPS 3R Burung Bao</h3>
      ...
      <div class="container">
        ...
        <div class="section-header light">
          ...
          <p class="section-subtitle">
            Capaian dan dampak nyata TPS 3R Burung Bao untuk lingkungan
          </p>
        </div>
    ...
    <section class="fasilitator-section">
      <div class="container">
        <div class="section-header">
          <h2 class="section-title">Fasilitator Desa Burung Bao</h2>
          <div class="title-underline"></div>
        </div>
...
import { 
  ...
  getMapUrl,
  contactFacilitator 
} from '@/scripts/krsite/sanding.js'
...
<style scoped src="@/assets/css/krsite/sanding.css"></style>
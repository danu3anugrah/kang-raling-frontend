...
export const tps3rData = {
  ...
  name: "TPS 3R BURUNG BAO",
  location:
    "Desa Muara Sanding, Kec. Garut Kota, Kabupaten Garut, Jawa Barat 44119",
  manager: "KSM TPS 3R Burung Bao",
  responsiblePerson: "-",
  familiesServed: "-",

  // Data fasilitator
  facilitator: {
    name: "Muhammad Iqbal Mujahid Akbar, S.E.",
  ...
  description: "TPS 3R Burung Bao merupakan pusat pengelolaan sampah terpadu yang melayani masyarakat Desa Muara Sanding. Dengan komitmen kuat dalam menerapkan prinsip 3R (Reduce, Reuse, Recycle), kami berfokus pada pengelolaan sampah yang berkelanjutan. Layanan kami mencakup pengumpulan sampah terpilah, pengolahan sampah organik menjadi kompos, dan berbagai program edukasi lingkungan untuk meningkatkan kesadaran masyarakat tentang pentingnya pengelolaan sampah yang baik.",
};
...
export const getMapUrl = () => {
  const location = "TPS 3R Burung Bao, Garut";

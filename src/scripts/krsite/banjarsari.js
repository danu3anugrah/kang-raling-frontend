...
export const tps3rData = {
  ...
  name: "TPS 3R BANJARSARI",
  location: "Desa Banjarsari, Kec. Samarang, Kabupaten Garut, Jawa Barat 44162",
  manager: "KSM TPS 3R Banjarsari",
  responsiblePerson: "-",
  familiesServed: "370",
  
  // Data fasilitator
  facilitator: {
    name: "Rivan Alawi, S.Hut",
  ...
  programs: [
    {
      ...
      description: "Sampah dikumpulkan dari warga yang telah memilah dari sumbernya menjadi organik, anorganik, dan residu."
    },
    {
      id: 2,
      title: "Pengolahan Sampah Organik",
      description: "Sampah organik diolah menjadi kompos."
    },
    {
      id: 3,
      title: "Pelatihan & Edukasi",
      description: "Kegiatan rutin peningkatan kapasitas warga dalam pengelolaan sampah dan kesadaran lingkungan."
    }
  ],
  ...
  description: `TPS 3R Banjarsari merupakan pusat pengelolaan sampah terpadu yang melayani masyarakat Desa Banjarsari. Dengan komitmen kuat dalam menerapkan prinsip 3R (Reduce, Reuse, Recycle), kami berfokus pada pengelolaan sampah yang berkelanjutan. Layanan kami mencakup pengumpulan sampah terpilah, pengolahan sampah organik menjadi kompos, dan berbagai program edukasi lingkungan untuk meningkatkan kesadaran masyarakat tentang pentingnya pengelolaan sampah yang baik.`
}
...
export const getMapUrl = () => {
  const location = "TPS 3R Desa Banjarsari, Garut"
